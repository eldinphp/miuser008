...
```json
{
  "projectName" : "miuser008",
  "repositoryPrefix" : "registry.lab.livefire.dev"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [tanzu-java-web-app->miuser008]
...
┃ ┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [your-registry.io/project->registry.lab.livefir...(truncated)]
